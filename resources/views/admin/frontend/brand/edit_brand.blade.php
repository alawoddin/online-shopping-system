            ...
            <div class="nk-block-head nk-page-head">
                <div class="nk-block-head-between">
                    <div class="nk-block-head-content">
                        <h2 class="display-6">Edit Brand </h2>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.feature', $brands->id) }}" method="post"
                            ...
                            <div class="row g-3 gx-gs">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="link" value="{{ $brands->link }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Brand Image </label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <img id="showImage"
                                                src="{{ !empty($brands->image) ? asset($brands->image) : asset('upload/no_image.jpg') }}"
