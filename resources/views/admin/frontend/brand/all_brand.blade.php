    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            ...
            <div class="nk-block-head nk-page-head">
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="display-6">All Brand </h2>
            ...
            <div class="d-flex align-items-center justify-content-between border-bottom border-light mt-5 mb-4 pb-2">
                <h5>All Brand </h5>
                <div class="nk-block-head-content">
                    <a href="{{ route('add.brand') }}" class="bg-info p-3 rounded text-black">Add Brand</a>
                        ...
                        @foreach ($brands as $key => $item)
                            <tr>
                                ...
                                <td class="tb-col tb-col-sm">
                                    ...
                                    <a href="{{ route('delete.brand', $item->id) }}" class="btn btn-danger btn-sm"
                                        id="delete">Delete</a>
                                </td>
