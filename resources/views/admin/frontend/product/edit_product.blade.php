                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.product', $alldata->id) }}" method="post"
                            ...
                            <div class="row g-3 gx-gs">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Product
                                            Price</label>
                                        <div class="form-control-wrap">
                                            <input type="text" name="price" value="{{ $alldata->price }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Product
                                            Discount</label>
                                        <div class="form-control-wrap">
                                            <input type="text" name="discount" value="{{ $alldata->discount }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Product Image </label>
                                        <div class="form-control-wrap">
